...
class FirstPersonCamera {
  constructor(camera, objects) {
    ...
    this.translation_ = new THREE.Vector3(0, 10, 0);
    this.phi_ = 0;
    this.phiSpeed_ = 8;
    this.theta_ = 0;
    this.thetaSpeed_ = 5;
...
class FirstPersonCameraDemo {
  ...
  initializeScene_() {
    ...
    const texture = loader.load([
      "./resources/skybox/posx.jpeg",
      "./resources/skybox/negx.jpeg",
      "./resources/skybox/posy.jpeg",
      "./resources/skybox/negy.jpeg",
      "./resources/skybox/posz.jpeg",
      "./resources/skybox/negz.jpeg",
    ]);
